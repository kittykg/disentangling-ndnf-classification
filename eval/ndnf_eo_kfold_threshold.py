"""
This script thresholds pruned plain NDNF, across multiple seeds. The input NDNF
models are strictly after pruning stage in the post-training processing
pipeline. The thresholded NDNF model are stored and evaluated. The evaluation
