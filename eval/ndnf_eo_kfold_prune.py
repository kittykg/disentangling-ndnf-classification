"""
This script prunes the plain NDNF part of its corresponding NDNF-EO model,
across multiple seeds. The input NDNF-EO models are strictly after training and
without any post-training processing. The pruned NDNF model are stored and
evaluated. The evaluation metrics include accuracy, sample Jaccard, and macro
Jaccard.
"""
