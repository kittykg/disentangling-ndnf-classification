"""
This script thresholds pruned MonkNeuralDNF model. The input NDNF models are
strictly after pruning stage in the post-training processing pipeline. The
thresholded MonkNeuralDNF models are stored and evaluated. The evaluation
...
def single_model_threshold(
    ...
    prune_log = _eval_with_log_wrapper(
        "Pruned Monk NDNF model (test)", test_loader
    )
    log.info("------------------------------------------")
