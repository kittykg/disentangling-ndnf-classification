...
from monk.data_utils_monk import get_x_and_y_monk
from monk.models import MonkClassifier, MonkNeuralDNF
...
def monk_classifier_eval(
    ...
    model.eval()
    is_ndnf = isinstance(model, MonkNeuralDNF)
    if is_ndnf:
    ...
    for i, data in enumerate(data_loader):
        with torch.no_grad():
            x, y = get_x_and_y_monk(data, device, use_ndnf=is_ndnf)
