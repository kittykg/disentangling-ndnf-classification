...
def single_model_disentangle(
    ...
    def disentangle(model: CDCNeuralDNF) -> dict[str, Any]:
        ...
        _eval_with_log_wrapper(
            model,
            "Disentangled CDC NDNF (intermediate, no prune, val)",
        )
        log.info("------------------------------------------")
        ...
        pruned_inter_model_log = _eval_with_log_wrapper(
            model,
            "Disentangled CDC NDNF model (intermediate, pruned, val)",
        )
        log.info("------------------------------------------")
        ...
        condensed_model_log = _eval_with_log_wrapper(
            model,
            "Disentangled CDC NDNF model (condensed, test)",
            test_loader,
        )
...
def multirun_disentangle(cfg: DictConfig):
    ...
    with open("disentangle_results.json", "w") as f:
