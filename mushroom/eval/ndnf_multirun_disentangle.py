...
def single_model_disentangle(
    ...
    def disentangle(model: MushroomNeuralDNF) -> dict[str, Any]:
        ...
        _eval_with_log_wrapper(
            model,
            "Disentangled Mushroom NDNF (intermediate, no prune, val)",
        )
        log.info("------------------------------------------")
        ...
        pruned_inter_model_log = _eval_with_log_wrapper(
            model,
            "Disentangled Mushroom NDNF model (intermediate, pruned, val)",
        )
        log.info("------------------------------------------")
        ...
        condensed_model_log = _eval_with_log_wrapper(
            model,
            "Disentangled Mushroom NDNF model (condensed, test)",
            test_loader,
        )
