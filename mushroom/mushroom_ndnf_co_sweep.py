...
from mushroom.train_mushroom_ndnf_constrained import train
...
def train_wrapper(cfg: DictConfig):
    ...
    cfg["training"]["opt_theta_lr"] = wandb.config.opt_theta_lr
    cfg["training"][
        "opt_theta_weight_decay"
    ] = wandb.config.opt_theta_weight_decay
    cfg["training"]["opt_theta_scheduler_step"] = int(
        wandb.config.opt_theta_scheduler_step
    )

    cfg["training"]["opt_lambda_lr"] = wandb.config.opt_lambda_lr
    cfg["training"]["opt_lambda_scheduler_step"] = int(
        wandb.config.opt_lambda_scheduler_step
    )
    cfg["training"][
        "opt_lambda_scheduler_gamma"
    ] = wandb.config.opt_lambda_scheduler_gamma
